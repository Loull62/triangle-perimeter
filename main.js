...
function btnClicked() {
    ...
    // document.getElementById('perimeterTotal').innerHTML = dist(vertxA, vertxB, vertyB, vertyC)
    document.getElementById('cLength').innerHTML = cData(vertyA, vertyB);
}
...
//     let bValue = Math.sqrt(aValue**2 + bValue**2);

//     return bValue;
// }

function cData(y1Val, y2Val) {
    document.getElementById('cLength').value;
    let cDisp = y1Val - y2Val;
    return cDisp;
}
